...
__sprite_init__(this, spr_counter, 192, 64, 0, 0, 'Box', 96, 0, 192, 0, 64, ['img/spr_counter_0.png']);
}; var spr_counter = new __spr_counter();

function __spr_counted() { 
__sprite_init__(this, spr_counted, 192, 64, 0, 0, 'Box', 96, 0, 192, 0, 64, ['img/spr_counted_0.png','img/spr_counted_1.png']);
...
function __spr_but() { 
__sprite_init__(this, spr_but, 320, 213, 160, 106, 'Box', 160, 0, 320, 0, 213, ['img/spr_but_0.png','img/spr_but_1.png']);
...
if (keyboard_check(vk_space) && this.jump == 0){
	this.jump = 1;	
	alarm[0] = 8;
	};
if (mouse_check() && this.jump == 0){
	this.jump = 1;	
	alarm[0] = 8;
	};
if (this.jump == 1){
...
if (place_meeting(this.x, this.y, obj_eatmask) && this.counted ==0){
	this.counted = 1;
...
__instance_init__(this, obj_water5, null, 1, 21, spr_water, 1, 20);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
__instance_init__(this, obj_water6, null, 1, 24, spr_water, 1, 21);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
__instance_init__(this, obj_water7, null, 1, 27, spr_water, 1, 22);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
__instance_init__(this, obj_cloud1, null, 1, 3, spr_clouds, 1, 25);
this.on_creation = function() {
with(this) {
this.image_speed = 0;
this.y = 432;
...
if (place_meeting(this.x, this.y, obj_eatmask)){
...
function __obj_trophy() {
__instance_init__(this, obj_trophy, null, 1, 26, spr_whale, 1, 45);
this.on_creation = function() {
with(this) {
this.image_speed = 0.2;
this.image_xscale = 0.32768;
...
if (this.color == 2){
	this.sprite_index = spr_saddle;
	};
if (this.color == 3){
	this.sprite_index = spr_shark;
	};
if (this.color == 4){
	this.sprite_index = spr_dolphin;
	};
if (this.color == 5){
	this.sprite_index = spr_jake;
	};
if (this.color == 6){
	this.sprite_index = spr_killer;
	};
if (this.color == 7){
	this.sprite_index = spr_flowers;
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var obj_trophy = new __obj_trophy();

function __obj_intro() {
__instance_init__(this, obj_intro, null, 1, 1, spr_intro, 1, 48);
this.on_creation = function() {
with(this) {
...
function __obj_but() {
__instance_init__(this, obj_but, null, 1, 0, spr_but, 1, 52);
this.on_creation = function() {
with(this) {
